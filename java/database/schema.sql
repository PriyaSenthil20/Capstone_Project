...
('Medium Rocco Special', 'Medium Special Pizza', 1, 15, true, 2),
('Large Rocco Special', 'Large Special Pizza', 1, 22, true, 3),
('Apollo Special', 'A supreme blend of toppings for a truly satisfying bite.', 1, 15.99, true, 2),
('LeiEd', 'A masterful selection for a pizza king.', 1, 15.99, true, 2),
